...
//    constructor(context: Context?, spanCount: Int): super(context, spanCount)
    val mMeasuredDimension = IntArray(3)
    ...
    fun measureScrapChild(recycler: RecyclerView.Recycler, position: Int, widthSpec: Int, heightSpec: Int, measuredDimension: IntArray){
